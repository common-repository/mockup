<div class="table table_content">
	...
	<table cellspacing="0" cellpadding="0" width="100%">
		...
		<tbody valign="top">
			...
			<tr>
				<td width="25%"><span><strong><?php _e('Introduction overlay', 'MockUp'); ?></strong></span></td>
				<td width="75%">
					<select id="mockup_intro_settings" name="mockup_intro_settings" width="300" style="width: 300px">
						<option value="hide"<?php if($mockup_intro == 'hide' || empty($mockup_intro) ) { echo ' selected="hide"'; } ?>><?php _e('Don\'t show the introduction overlay', 'MockUp'); ?></option>
